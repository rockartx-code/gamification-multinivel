...
# ---------------------------------------------------------------------------
# Configuración del negocio — ÚNICA fuente de verdad de los valores por defecto
# ---------------------------------------------------------------------------
# Toda lectura de configuración pasa por `_load_app_config`, que fusiona lo
# guardado en DynamoDB sobre estos defaults. Antes cada lambda repetía su propio
# valor por defecto en la llamada (`cfg.get("activationNetMin", 2500)` en un
# módulo, `..., 50)` en otro, `..., 20)` en un tercero) y además con unidades
# distintas: la misma persona podía salir activa en una pantalla e inactiva en
# otra si la clave no estaba guardada.
